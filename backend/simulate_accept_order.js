...
// Using the Order ID from the last check (I'll need to grab it from previous output, but I'll query it first here)
...
const simulate = async () => {
    try {
        ...
        console.log(`Attempting to confirm Order: ${order._id}`);
